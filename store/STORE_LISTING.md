# Chrome Web Store — Listing Copy (FloatTube)

Copy/paste these into the Web Store developer dashboard. English is the primary
listing; Turkish is provided for a localized listing if you add one.
...
```
> ⚠️ Do **not** put "YouTube" first in the name or use the YouTube logo. "For
> YouTube" is fine in the description. Keep the affiliation disclaimer.
...
## Language
```
English (primary) — optionally add Turkish
```
...
• A–B repeat to loop any section.
• Download the thumbnail (Max / HQ / MQ).
...
• Herhangi bir bölümü döngüye almak için A–B tekrar.
• Thumbnail indir (Max / HQ / MQ).
• Tüm istatistikleri JSON olarak dışa aktar.
...
- Health / financial / authentication / location / web history / user activity: **No**
...
- "I do not use or transfer user data to determine creditworthiness or for lending": **check**

## Privacy policy URL
```
Host store/PRIVACY.md somewhere public (e.g. a GitHub repo "raw" link or GitHub
Pages) and paste that URL here. A privacy policy URL is REQUIRED.
```
